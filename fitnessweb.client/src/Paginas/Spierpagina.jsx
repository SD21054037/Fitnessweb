...
const muscles = [
    ...
    { name: 'Abductor pollicis longus', description: 'The abductor pollicis longus is a muscle in the forearm that functions to abduct and extend the thumb at the wrist. It is essential for thumb movement and grip strength.', path: '/upperbody2.glb' },
    ...
    { name: 'Pronator teres', description: 'The pronator teres muscle helps in pronating the forearm, allowing the palm to turn downward.', path: '/upperbody2.glb' },
    { name: 'Rhomboid major', description: 'The rhomboid major muscle is located in the upper back and is responsible for retracting and stabilizing the scapula.', path: '/upperbody2.glb' },
    { name: 'Rhomboid minor', description: 'The rhomboid minor is a small muscle of the upper back that assists in scapular retraction and stabilization.', path: '/upperbody2.glb' },
    { name: 'Serratus posterior inferior', description: 'The serratus posterior inferior is a back muscle that helps in forced expiration by depressing the lower ribs.', path: '/upperbody2.glb' },
    { name: 'Spinal erectors', description: 'The spinal erectors are a group of muscles along the spine that play a key role in maintaining posture and allowing for back extension.', path: '/upperbody2.glb' },
    { name: 'Teres major', description: 'The teres major is a muscle of the upper back that assists in shoulder extension, adduction, and medial rotation.', path: '/upperbody2.glb' },
    ...
    { name: 'Adductor brevis', description: 'The adductor brevis is a short muscle in the inner thigh responsible for hip adduction, helping bring the leg toward the midline of the body. It also assists in hip flexion and rotation.', path: '/lowerbody2.glb' },
    { name: 'Adductor longus', description: 'The adductor longus is a thigh muscle that plays a key role in hip adduction, flexion, and medial rotation, essential for movements like walking, running, and stabilizing the pelvis.', path: '/lowerbody2.glb' },
    { name: 'Adductor magnus', description: 'The adductor magnus is a large inner thigh muscle involved in hip adduction, extension, and rotation. It contributes to powerful leg movements and overall lower body stability.', path: '/lowerbody2.glb' },
    ...
    { name: 'Iliotibial tract', description: 'The iliotibial tract (IT band) is a thick band of connective tissue that helps stabilize the knee during walking, running, and other lower body movements.', path: '/lowerbody2.glb' },
    ...
    { name: 'Vastus intermedius', description: 'The vastus intermedius is one of the quadriceps muscles that helps extend the knee, playing a key role in leg movement and stability.', path: '/lowerbody2.glb' },
...
const MuscleModel = ({ selectedMuscle }) => {
    ...
    if (!gltf) return null; // Ensure the model is loaded before rendering

    if (selectedMuscle.path === '/lowerbody2.glb') {
        return <primitive object={gltf.scene} scale={[1.5, 1.5, 1.5]} position={[1.8, -0.8, 0]} rotation={[0, Math.PI, 0]} />;
    } else if (selectedMuscle.path === '/upperbody2.glb') {
        return <primitive object={gltf.scene} scale={[1.5, 1.5, 1.5]} position={[1.8, -1.8, 0]} rotation={[0, Math.PI, 0]} />;
    }
